this.module1 = {
    allpages: new Func('Allpages',
        function(){
            ...
            log(Torn.user.stats.working());
            log(Torn.user.stats.battle());
            log(Torn.user.stats.faction());
            log(Torn.user.stats.gym());
            log(Torn.user.stats.poker());
            log(Torn.user.stats.racing());
